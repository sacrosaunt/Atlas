...
/usr/bin/swiftc -target arm64-apple-macos14.0 -parse-as-library "$project_dir/src/AtlasApp.swift" -framework SwiftUI -framework LocalAuthentication -framework AppKit -framework UserNotifications -o "$project_dir/bin/Atlas"
